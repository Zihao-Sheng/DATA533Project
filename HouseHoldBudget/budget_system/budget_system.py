...
class BudgetSystem:
    ...
    def add_fund(self, amount, description=''):
        return self.fund.add(amount, description)

    def sub_fund(self, amount, description=''):
        return self.fund.sub(amount, description)
